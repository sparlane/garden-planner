...
const queryKeys = {
  ...
  plantings: {
    ...
    gardenRegisterAll: ['plantings', 'garden-register'] as const,
    gardenRegister: (filters: object) => ['plantings', 'garden-register', filters] as const,
    gardenRegisterDetail: (key: string) => ['plantings', 'garden-register', 'detail', key] as const,
