...
pylint applications/ costing/ frontend/ garden/ health/ inventory/ labels/ locations/ plantings/ plants/ reporting/ sales/ seeds/ seedtrays/ supplies/ tax/ tests/ work/ workspaces/
